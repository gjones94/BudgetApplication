...
namespace BudgetApp.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if(budget != null)
            {
                _userServiceManager.RemoveFromEntitySafely(user.Id, budget.EntityId, RoleName.Owner); //==> Dependent on application as to which entities and roles need safe removal
            }
