...
namespace BudgetApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<User> signInManager, ILogger<LoginModel> logger, UserServiceManager userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    userIsAdmin = await _signInManager.UserManager.IsInRoleAsync(user, RoleName.Admin);

                    if (user.ApprovedByAdmin == false && userIsAdmin == false)
                    {
